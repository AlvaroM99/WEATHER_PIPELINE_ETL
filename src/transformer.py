        ...
        for bronze_obj in bronze_objects:
            try:
                ...
                transformed: TransformedRecord = {
                    ...
                    "weather_id": raw_data.get("weather", [{}])[0].get("id"),
                    ...
                    "rain_1h": raw_data.get("rain", {}).get("1h"),
                    "rain_3h": raw_data.get("rain", {}).get("3h"),
                    "snow_1h": raw_data.get("snow", {}).get("1h"),
                    "snow_3h": raw_data.get("snow", {}).get("3h"),
                    "date": execution_date,
